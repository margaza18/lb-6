...
print("\nAdd first book.\n")
library.add_book("The little Prince", 1942, "Novel")

print("\nAdd second book.\n")
library.add_book("Through the Eyes of the Killer", 2018, "Detective story")

print("\nFound book with id 1.\n")
library.find_book_by_id(1)

print("\nFound book with author name.\n")
library.find_book_by_field("Author", "Through the Eyes of the Killer")
